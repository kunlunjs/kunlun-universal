---
title: 如何更好的写 Tailwind CSS
introduction: 一些写 Tailwind CSS 的小技巧
author: Yudong Zhu
recommend: true
star: 3
categories: 在线文档
...
Got some tips to add to add? [Create a PR on GitHub](https://github.com/turing-dev/kunlun-universal).
...
You can use something like [Headwind](https://github.com/turing-dev/kunlun-universal) to do this for you.
